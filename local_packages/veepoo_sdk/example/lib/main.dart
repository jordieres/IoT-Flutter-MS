...
class _MyAppState extends State<MyApp> {
  ...
  Widget buildButtonRow(String text1, VoidCallback onPressed1, String text2, VoidCallback onPressed2) {
    return Row(
      children: <Widget>[
        ElevatedButton(
          child: Text(text1),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Column(
            children: <Widget>[
              ListTile(
                title: Text("${listDevice[index].name} - ${listDevice[index].mac} - ${listDevice[index].rssi}"),
