...
//NOTUSED
  ...
  static Future<void> connectDevice(int deviceIndex) async {
    try {
      ...
      print("the metawearAPI----SEnd this to connect AMIR $deviceIndex");
    } on PlatformException catch (e) {
  ...
  static Future<void> sendIdNumber(String refNumber) async {
    print("METAWEARAPI-the id number received in service api from the main with the id $refNumber");
