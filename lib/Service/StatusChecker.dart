...
class StatusChecker {
  ...
  ////////Uploader times////////////////////////
  int Allowed_initialDelayMinutes_Upload = 1; //TODO MUST BE 20 MIN
  int Allowed_updateIntervalMinutes_Upload = 2; //TODO MUST BE 30 MIN
...
//////////////////Uploader////////////
  ...
  //     } catch (e) {
  //       print("Error parsing date from string: $e $timestamp");
  //     }
  //   }
  //   return null;
  // }
//TODO:MUST CHECK ALSO NEW FUNCTIONS WORKS FINE IN ANDROID OR NOT
  DateTime? _parseDateTime(dynamic timestamp) {
    if (timestamp is int) {
      return DateTime.fromMillisecondsSinceEpoch(timestamp);
    } else if (timestamp is String) {
