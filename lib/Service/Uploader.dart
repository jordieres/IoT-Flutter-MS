...
class Uploader {
  ...
  // static Future<void> startUploading() async {//TODO CHECK IF NEW METHOD WORKING FINE INA NDROID AND IOS SO DELETE THIS
  ...
  static Future<void> startUploading() async {
    ...
    if (files.isEmpty) {
      print("Checked for files to upload, but none were found.");
      // lastUploadTimestamp = DateTime.now();TODO MUST BE UNCOMMENTED JUST FOR TEST
      return;
    }
